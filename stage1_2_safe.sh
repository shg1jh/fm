...
# Resume from the best safe Stage 1 v4 checkpoint.
RESUME_CHECKPOINT="results/checkpoints_stage1_hr_v4_delta/stage1_hr_step2000.pth.tar"

# Stage 1.2 safe-scope training outputs.
SAVE_DIR="results/checkpoints_stage1_2_hr_v4_safe"
LOG_DIR="results/logs_stage1_2_hr_v4_safe"
LOG_FILE="${LOG_DIR}/train_stage1_2_hr_v4_safe_$(date +%Y%m%d_%H%M%S).txt"

mkdir -p "$SAVE_DIR" "$LOG_DIR"

echo "Starting NVC-FM-HR Stage 1.2 safe-scope training..."
...
echo "Stage 1.2 HRS safe-scope training finished."
